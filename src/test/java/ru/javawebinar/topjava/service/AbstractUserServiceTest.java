...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    @Test
    public void updateUserWithoutRoles() {
        User updatedWithoutRoles = getUpdatedUserWithoutROles();
        service.update(updatedWithoutRoles);
        USER_MATCHER.assertMatch(service.get(USER_ID), getUpdatedUserWithoutROles());
    }

    @Test
    public void updateUserWithZeroRoles() {
        User updatedWithZeroRoles = getUpdatedUserWithZeroRoles();
        service.update(updatedWithZeroRoles);
        USER_MATCHER.assertMatch(service.get(USER_ID), getUpdatedUserWithZeroRoles());
    }
